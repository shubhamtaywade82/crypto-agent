 ...
 */
export declare function aggregateMarketState(streamStates: ReadonlyMap<string, StreamMarketState>, options?: MarketStateAggregatorOptions): AggregatedMarketState;
