...
export type MarketEventType = 'fvg' | 'ifvg' | 'order_block' | 'breaker_block' | 'bos' | 'choch' | 'mss' | 'liquidity_sweep' | 'displacement' | 'vsa' | 'derivatives' | 'wyckoff' | 'chart_pattern' | 'harmonic_pattern' | 'control';
...
export declare function validateEventCausality(event: BaseEvent): void;
...
export type LiquidityPoolType = 'single_high' | 'single_low' | 'equal_highs' | 'equal_lows' | 'session_high' | 'session_low' | 'pdh' | 'pdl' | 'cluster';
...
export type VsaEventType = 'stopping_volume' | 'no_demand' | 'no_supply' | 'effort_vs_result' | 'climax';
...
export type DerivativesEventType = 'oi_expansion' | 'oi_contraction' | 'funding_extreme' | 'aggressive_taker_flow';
...
export type WyckoffEventType = 'spring' | 'upthrust' | 'selling_climax' | 'buying_climax' | 'sign_of_strength' | 'sign_of_weakness';
...
export type ChartPatternType = 'double_top' | 'double_bottom' | 'ascending_triangle' | 'descending_triangle';
...
export type MarketEvent = FvgEvent | InvertedFvgEvent | OrderBlockEvent | BreakerBlockEvent | StructureBreakEvent | LiquiditySweepEvent | DisplacementEvent | VsaEvent | DerivativesEvent | WyckoffEvent | ChartPatternEvent | HarmonicPatternEvent;
