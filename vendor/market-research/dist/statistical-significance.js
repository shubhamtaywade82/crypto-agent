 ...
 */
export function calculateWilsonInterval(successes, trials, z = 1.96) {
    if (trials === 0) {
 ...
 */
export function calculateClusterEffectiveSampleSize(clusterSizes, icc = 0.25) {
 ...
 */
export function calculateBootstrapMedianCi(values, iterations = 500, seed = 42) {
    if (values.length === 0)
...
export function calculateClusterBootstrapComparison(eventClusters, baselineClusters, iterations = 1000, seed = 42) {
...
export function calculatePairedBootstrapComparison(pairs, iterations = 1000) {
    const n = pairs.length;
    if (n === 0)
        return { meanDifference: 0, standardError: 0, pValue: 1.0, confidenceInterval: { lower: 0, upper: 0 } };
...
function parseBaselineInput(arg1, arg2, arg3, arg4, arg5) {
...
export function compareAgainstBaseline(inputOrHits, eventTrials, baselineHits, baselineTrials, clusterSizes) {
...
//# sourceMappingURL=statistical-significance.js.map