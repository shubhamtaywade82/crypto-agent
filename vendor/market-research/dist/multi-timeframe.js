 ...
 */
export function getCausalHtfCandles(htfCandles, eventTimestamp, htf) {
 ...
 */
export function extractCausalHtfContext(htfCandles, eventTimestamp, htf) {
    const causalCandles = getCausalHtfCandles(htfCandles, eventTimestamp, htf);
    if (causalCandles.length < 2)
        return null;
 ...
 */
export function extractMultiTimeframeSnapshot(htfCandlesMap, eventTimestamp) {
    const result = {};
    for (const [tf, candles] of Object.entries(htfCandlesMap)) {
...
//# sourceMappingURL=multi-timeframe.js.map