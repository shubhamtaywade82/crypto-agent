...
export type PathResolution = 'single_bar_unambiguous' | 'ohlc_resolved' | 'ohlc_collision' | 'lower_tf_resolved' | 'tick_resolved' | 'ohlc_pessimistic' | 'ohlc_optimistic' | 'ambiguous' | 'exact';
...
export type EventOutcome = DirectionalOutcome | FvgOutcome | OrderBlockOutcome | StructureOutcome | LiquiditySweepOutcome | ZoneOutcome;
...
export type EvidenceStatus = 'descriptive_only' | 'exploratory' | 'train_supported' | 'oos_supported' | 'robust' | 'insufficient_sample' | 'confounded';
