import { detectSwings, detectStructureBreaks, detectFvg, detectBos, detectChoch, detectMss, detectOrderBlocks, detectLiquiditySweeps, detectDisplacement, } from '@nemesis-oss/market-events';
...
export class StateTracker {
    ...
    detectors;
    eventLookbackBars;
    constructor(symbol, timeframe, buffer, detectors, eventLookbackBars) {
        this.symbol = symbol;
